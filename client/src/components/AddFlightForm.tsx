...
export function AddFlightForm(props: AddFlightFormProps) {
  ...
  const planeOptions = coalition ? coalition.countries['USA'].planes.map(plane => {
  ...
  return (
    <div className="Popup">
      ...
      <p>Number<input type="text" pattern="[1-4]" defaultValue="2" onChange={onNumberChange} /></p>
      <p><button onClick={addFlightOnClick}>Add flight</button></p>
    </div>
  );
